...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__api_fetch_1__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_utils__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vuex_persistedstate__ = __webpack_require__(102);
...
var mutations = {
    setShowing: function setShowing(state, data) {
        state.showing = data;
    },
    setIv_salt: function setIv_salt(state, data) {
        state.iv_salt = data;
    },
    setIv_salt1: function setIv_salt1(state, data) {
        state.iv_salt1 = data;
    },
    setLevelList: function setLevelList(state, data) {
        state.levelList = data;
    },
    setUserInfo: function setUserInfo(state, data) {
        state.userInfo = data;
    },
    setBindCard: function setBindCard(state, data) {
        state.bindCard = data;
    },
    setCustomerid: function setCustomerid(state, data) {
        state.customerid = data.data;
    },
    setCustomer_id: function setCustomer_id(state, data) {
        state.customer_id = data;
    },
    setRegister: function setRegister(state, data) {
        state.register = data;
    },
    setBinded: function setBinded(state, data) {
        state.binded = data.data;
    },
    setCardInfo: function setCardInfo(state, data) {
        state.cardinfo = data;
    },
    setQrcode: function setQrcode(state, data) {
        state.qrcode = data.data;
    },
    setUnbind: function setUnbind(state, data) {
        state.unbind = data.data;
    },
    setRechargeRule: function setRechargeRule(state, data) {
        state.recharge_rule = data;
    },
    setCustom_rule: function setCustom_rule(state, data) {
        state.custom_rule = data;
    },
    setApplicablestores: function setApplicablestores(state, data) {
        state.applicablestores = data;
    },
    setCompany: function setCompany(state, data) {
        state.company = data;
    },
    setRedrule: function setRedrule(state, data) {
        state.red_rule = data;
    },
    setDetail: function setDetail(state, data) {
        state.detail = data;
    },
    setStock: function setStock(state, data) {
        state.stock = data;
    },
    setRulelist: function setRulelist(state, data) {
        state.rulelist = data;
    },
    setExchange: function setExchange(state, data) {
        state.exchange = data;
    },
    setCouponDetail: function setCouponDetail(state, data) {
        state.coupon_detail = data;
    },
    setRecharge: function setRecharge(state, data) {
        state.recharge = data;
    },
    setOpenid: function setOpenid(state, data) {
        state.openid = data.op;
    },
    setKtvList: function setKtvList(state, data) {
        state.ktvList = data;
    },
    setUpdate: function setUpdate(state, data) {},
    setOpenid_SK: function setOpenid_SK(state, data) {
    ...
    setVerifyCode: function setVerifyCode(state, data) {},
    setDdata: function setDdata(state, data) {
...
var actions = {
    setUserInfo: function setUserInfo(_ref) {
        ...
        var res1 = wx.request({
            method: 'post',
            url: __WEBPACK_IMPORTED_MODULE_6__utils_utils__["a" /* default */].API + '/member/api/iv_salt',
                ...
                if (!res1.data.ret) {
                    ...
                    wx.login({
                        success: function success(res) {
                            if (res.code) {
                                var result = Object(__WEBPACK_IMPORTED_MODULE_5__api_fetch_1__["a" /* newrequest */])({
                                    method: 'post',
    ...
    setUserInfo1: function setUserInfo1(_ref2) {
        ...
        var res1 = wx.request({
            ...
            success: function success(res1) {
                ...
                if (!res1.data.ret) {
                    ...
                    wx.login({
                        success: function () {
                            var _ref3 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(res) {
                                var result, res2, url;
    ...
    //转发接口
    getForward: function getForward(_ref4, params) {
        var _this2 = this;
    ...
    //获取customerId
    member_bind: function member_bind(_ref5, params) {
        var _this3 = this;
...
var CryptoJS1 = __webpack_require__(100);
...
function generateKey(salt, iterationCount) {
  var key = CryptoJS1.PBKDF2(pw, CryptoJS.enc.Hex.parse(salt), { keySize: keySize, iterations: iterationCount });
  return key;
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_json_stringify__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_utils__ = __webpack_require__(32);
...
var request = function () {
  var _ref = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_asyncToGenerator___default()( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(obj) {
    var iv_salt;
    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            iv_salt = __WEBPACK_IMPORTED_MODULE_6__store_index__["a" /* default */].state.iv_salt;

            obj.data.content = Dec.Encrypt(iv_salt.salt, iv_salt.iv, iv_salt.count, __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_json_stringify___default()(obj.data.content));
            return _context.abrupt('return', new __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
              ...
              wx.request({
                url: __WEBPACK_IMPORTED_MODULE_5__utils_utils__["a" /* default */].API + obj.url,
                data: obj.data, //obj.data,
                header: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({
                ...
                success: function success(res) {
                  ...
                  if (obj.dontLoading !== true && __WEBPACK_IMPORTED_MODULE_6__store_index__["a" /* default */].state.showing !== true) {
                    wx.hideLoading();
                    wx.hideNavigationBarLoading();
                  }

                  __WEBPACK_IMPORTED_MODULE_6__store_index__["a" /* default */].commit('setShowing', false);
...
function handleNewToken(res) {
  var new_token = res.header['New-Token'];
  if (new_token) {
    __WEBPACK_IMPORTED_MODULE_6__store_index__["a" /* default */].commit('setToken', new_token);
  }
}
...
function showToast(message) {
  ...
  __WEBPACK_IMPORTED_MODULE_6__store_index__["a" /* default */].commit('setShowing', true);
}
/**
 * 处理code信息
 * @param res
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_identify_vue__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_352a28c3_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_identify_vue__ = __webpack_require__(108);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_identify_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_352a28c3_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_identify_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\identify.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] identify.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-352a28c3", Component.options)
  } else {
    hotAPI.reload("data-v-352a28c3", Component.options)
  }
...
/* harmony export (immutable) */ __webpack_exports__["barc"] = barc;
/* harmony export (immutable) */ __webpack_exports__["qrc"] = qrc;
/* harmony export (immutable) */ __webpack_exports__["formatTime"] = formatTime;
var barcode = __webpack_require__(118);
var qrcode = __webpack_require__(119);
...
var CryptoJS = CryptoJS || function (p, h) {
  var i = {},
    ...
    function a() {}return { extend: function extend(e) {
      ...
      o = l.WordArray = r.extend({ init: function init(a, e) {
      a = this.words = a || [];this.sigBytes = e != h ? e : 4 * a.length;
      ...
      var e = this.words,
          c = a.words,
          b = this.sigBytes,
          a = a.sigBytes;this.clamp();if (b % 4) for (var d = 0; d < a; d++) {
      ...
      var a = this.words,
          e = this.sigBytes;a[e >>> 2] &= 4294967295 << 32 - 8 * (e % 4);a.length = p.ceil(e / 4);
    }, clone: function clone() {
      var a = r.clone.call(this);a.words = this.words.slice(0);return a;
      ...
      for (var e = a.words, a = a.sigBytes, c = [], b = 0; b < a; b++) {
        var d = e[b >>> 2] >>> 24 - 8 * (b % 4) & 255;c.push((d >>> 4).toString(16));c.push((d & 15).toString(16));
      }return c.join("");
      ...
      n = m.Latin1 = { stringify: function stringify(a) {
      for (var e = a.words, a = a.sigBytes, c = [], b = 0; b < a; b++) {
      ...
      k = m.Utf8 = { stringify: function stringify(a) {
      try {
      ...
      f = l.BufferedBlockAlgorithm = r.extend({ reset: function reset() {
      this._data = o.create();
      this._nDataBytes = 0;
      ...
      var e = this._data,
        ...
        }j = c.splice(0, a);e.sigBytes -= b;
      }return o.create(j, b);
    }, clone: function clone() {
      var a = r.clone.call(this);a._data = this._data.clone();return a;
    }, _minBufferSize: 0 });l.Hasher = f.extend({ init: function init() {
      this.reset();
    },
    reset: function reset() {
      ...
      var a = f.clone.call(this);a._hash = this._hash.clone();return a;
...
(function () {
  var p = CryptoJS,
      h = p.lib.WordArray;p.enc.Base64 = { stringify: function stringify(i) {
      var l = i.words,
          h = i.sigBytes,
          o = this._map;i.clamp();for (var i = [], m = 0; m < h; m += 3) {
      ...
      var i = i.replace(/\s/g, ""),
          l = i.length,
          r = this._map,
          o = r.charAt(64);o && (o = i.indexOf(o), -1 != o && (l = o));
      for (var o = [], m = 0, s = 0; s < l; s++) {
        if (s % 4) {
          var n = r.indexOf(i.charAt(s - 1)) << 2 * (s % 4),
              k = r.indexOf(i.charAt(s)) >>> 6 - 2 * (s % 4);o[m >>> 2] |= (n | k) << 24 - 8 * (m % 4);m++;
        }
      }return h.create(o, m);
...
(function (p) {
  function h(f, g, a, e, c, b, d) {
    f = f + (g & a | ~g & e) + c + d;return (f << b | f >>> 32 - b) + g;
  }function i(f, g, a, e, c, b, d) {
    f = f + (g & e | a & ~e) + c + d;return (f << b | f >>> 32 - b) + g;
  }function l(f, g, a, e, c, b, d) {
    f = f + (g ^ a ^ e) + c + d;return (f << b | f >>> 32 - b) + g;
  }function r(f, g, a, e, c, b, d) {
    f = f + (a ^ (g | ~e)) + c + d;return (f << b | f >>> 32 - b) + g;
  }var o = CryptoJS,
      m = o.lib,
      s = m.WordArray,
      m = m.Hasher,
    ...
    for (var f = 0; 64 > f; f++) {
      ...
      }e[0] = e[0] + c | 0;e[1] = e[1] + b | 0;e[2] = e[2] + d | 0;e[3] = e[3] + q | 0;
    }, _doFinalize: function _doFinalize() {
      var f = this._data,
          g = f.words,
          a = 8 * this._nDataBytes,
          e = 8 * f.sigBytes;g[e >>> 5] |= 128 << 24 - e % 32;g[(e + 64 >>> 9 << 4) + 14] = (a << 8 | a >>> 24) & 16711935 | (a << 24 | a >>> 8) & 4278255360;f.sigBytes = 4 * (g.length + 1);this._process();f = this._hash.words;for (g = 0; 4 > g; g++) {
...
(function () {
  var p = CryptoJS,
      ...
      l = h.WordArray,
      h = p.algo,
      r = h.EvpKDF = i.extend({ cfg: i.extend({ keySize: 4, hasher: h.MD5, iterations: 1 }), init: function init(i) {
      ...
      for (var h = this.cfg, n = h.hasher.create(), k = l.create(), f = k.words, g = h.keySize, h = h.iterations; f.length < g;) {
        a && n.update(a);var a = n.update(i).finalize(m);n.reset();for (var e = 1; e < h; e++) {
          a = n.finalize(a), n.reset();
        }k.concat(a);
      }k.sigBytes = 4 * g;return k;
...
CryptoJS.lib.Cipher || function (p) {
  var h = CryptoJS,
      ...
      m = h.enc.Base64,
      s = h.algo.EvpKDF,
      n = i.Cipher = o.extend({ cfg: l.extend(), createEncryptor: function createEncryptor(b, d) {
      ...
      this.cfg = this.cfg.extend(a);this._xformMode = b;this._key = d;this.reset();
    }, reset: function reset() {
      o.reset.call(this);this._doReset();
    }, process: function process(b) {
      this._append(b);return this._process();
    },
    finalize: function finalize(b) {
      b && this._append(b);return this._doFinalize();
    }, keySize: 4, ivSize: 4, _ENC_XFORM_MODE: 1, _DEC_XFORM_MODE: 2, _createHelper: function () {
      return function (b) {
        return { encrypt: function encrypt(a, q, j) {
            return ("string" == typeof q ? c : e).encrypt(b, a, q, j);
          }, decrypt: function decrypt(a, q, j) {
            return ("string" == typeof q ? c : e).decrypt(b, a, q, j);
          } };
      };
    }() });i.StreamCipher = n.extend({ _doFinalize: function _doFinalize() {
      return this._process(!0);
    }, blockSize: 1 });var k = h.mode = {},
      f = i.BlockCipherMode = l.extend({ createEncryptor: function createEncryptor(b, a) {
      ...
      k = k.CBC = function () {
    function b(b, a, d) {
      var c = this._iv;c ? this._iv = p : c = this._prevBlock;for (var e = 0; e < d; e++) {
        b[a + e] ^= c[e];
      }
    }var a = f.extend();a.Encryptor = a.extend({ processBlock: function processBlock(a, d) {
        var c = this._cipher,
            e = c.blockSize;b.call(this, a, d, e);c.encryptBlock(a, d);this._prevBlock = a.slice(d, d + e);
      } });a.Decryptor = a.extend({ processBlock: function processBlock(a, d) {
        var c = this._cipher,
            e = c.blockSize,
            f = a.slice(d, d + e);c.decryptBlock(a, d);b.call(this, a, d, e);this._prevBlock = f;
      } });return a;
  }(),
      g = (h.pad = {}).Pkcs7 = { pad: function pad(b, a) {
      for (var c = 4 * a, c = c - b.sigBytes % c, e = c << 24 | c << 16 | c << 8 | c, f = [], g = 0; g < c; g += 4) {
        f.push(e);
      }c = r.create(f, c);b.concat(c);
    }, unpad: function unpad(b) {
      b.sigBytes -= b.words[b.sigBytes - 1 >>> 2] & 255;
    } };i.BlockCipher = n.extend({ cfg: n.cfg.extend({ mode: k, padding: g }), reset: function reset() {
      n.reset.call(this);var b = this.cfg,
          a = b.iv,
          b = b.mode;if (this._xformMode == this._ENC_XFORM_MODE) var c = b.createEncryptor;else c = b.createDecryptor, this._minBufferSize = 1;this._mode = c.call(b, this, a && a.words);
    }, _doProcessBlock: function _doProcessBlock(b, a) {
      this._mode.processBlock(b, a);
    }, _doFinalize: function _doFinalize() {
      var b = this.cfg.padding;if (this._xformMode == this._ENC_XFORM_MODE) {
        b.pad(this._data, this.blockSize);var a = this._process(!0);
      } else a = this._process(!0), b.unpad(a);return a;
    }, blockSize: 4 });var a = i.CipherParams = l.extend({ init: function init(a) {
      this.mixIn(a);
    }, toString: function toString(a) {
      return (a || this.formatter).stringify(this);
    } }),
      k = (h.format = {}).OpenSSL = { stringify: function stringify(a) {
      var d = a.ciphertext,
          a = a.salt,
          d = (a ? r.create([1398893684, 1701076831]).concat(a).concat(d) : d).toString(m);return d = d.replace(/(.{64})/g, "$1\n");
    }, parse: function parse(b) {
      var b = m.parse(b),
          d = b.words;if (1398893684 == d[0] && 1701076831 == d[1]) {
        var c = r.create(d.slice(2, 4));d.splice(0, 4);b.sigBytes -= 16;
      }return a.create({ ciphertext: b, salt: c });
    } },
      e = i.SerializableCipher = l.extend({ cfg: l.extend({ format: k }), encrypt: function encrypt(b, d, c, e) {
      var e = this.cfg.extend(e),
          f = b.createEncryptor(c, e),
          d = f.finalize(d),
          f = f.cfg;return a.create({ ciphertext: d,
      ...
      f = this.cfg.extend(f);c = this._parse(c, f.format);return a.createDecryptor(e, f).finalize(c.ciphertext);
    }, _parse: function _parse(a, c) {
      return "string" == typeof a ? c.parse(a) : a;
    } }),
      h = (h.kdf = {}).OpenSSL = { compute: function compute(b, c, e, f) {
      f || (f = r.random(8));b = s.create({ keySize: c + e }).compute(b, f);e = r.create(b.words.slice(c), 4 * e);b.sigBytes = 4 * c;return a.create({ key: b, iv: e, salt: f });
    } },
      c = i.PasswordBasedCipher = e.extend({ cfg: e.cfg.extend({ kdf: h }), encrypt: function encrypt(a, c, f, j) {
      j = this.cfg.extend(j);f = j.kdf.compute(f, a.keySize, a.ivSize);j.iv = f.iv;a = e.encrypt.call(this, a, c, f.key, j);a.mixIn(f);return a;
    }, decrypt: function decrypt(a, c, f, j) {
      j = this.cfg.extend(j);c = this._parse(c, j.format);f = j.kdf.compute(f, a.keySize, a.ivSize, c.salt);j.iv = f.iv;return e.decrypt.call(this, a, c, f.key, j);
    } });
}();
(function () {
  var p = CryptoJS,
    ...
    for (var c = [], b = 0; 256 > b; b++) {
      ...
      var j = e ^ e << 1 ^ e << 2 ^ e << 3 ^ e << 4,
          j = j >>> 8 ^ j & 255 ^ 99;l[d] = j;r[j] = d;var i = c[d],
          h = c[i],
          p = c[h],
          t = 257 * c[j] ^ 16843008 * j;o[d] = t << 24 | t >>> 8;m[d] = t << 16 | t >>> 16;s[d] = t << 8 | t >>> 24;n[d] = t;t = 16843009 * p ^ 65537 * h ^ 257 * i ^ 16843008 * d;k[j] = t << 24 | t >>> 8;f[j] = t << 16 | t >>> 16;g[j] = t << 8 | t >>> 24;a[j] = t;d ? (d = i ^ c[c[c[p ^ i]]], e ^= c[c[e]]) : d = e = 1;
    }
  })();
  var e = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
      i = i.AES = h.extend({ _doReset: function _doReset() {
      for (var c = this._key, b = c.words, d = c.sigBytes / 4, c = 4 * ((this._nRounds = d + 6) + 1), i = this._keySchedule = [], j = 0; j < c; j++) {
        if (j < d) i[j] = b[j];else {
          var h = i[j - 1];j % d ? 6 < d && 4 == j % d && (h = l[h >>> 24] << 24 | l[h >>> 16 & 255] << 16 | l[h >>> 8 & 255] << 8 | l[h & 255]) : (h = h << 8 | h >>> 24, h = l[h >>> 24] << 24 | l[h >>> 16 & 255] << 16 | l[h >>> 8 & 255] << 8 | l[h & 255], h ^= e[j / d | 0] << 24);i[j] = i[j - d] ^ h;
        }
      }b = this._invKeySchedule = [];for (d = 0; d < c; d++) {
      ...
      var d = c[b + 1];c[b + 1] = c[b + 3];c[b + 3] = d;this._doCryptBlock(c, b, this._invKeySchedule, k, f, g, a, r);d = c[b + 1];c[b + 1] = c[b + 3];c[b + 3] = d;
      ...
      for (var l = this._nRounds, k = a[b] ^ d[0], m = a[b + 1] ^ d[1], o = a[b + 2] ^ d[2], n = a[b + 3] ^ d[3], p = 4, r = 1; r < l; r++) {
        var s = e[k >>> 24] ^ f[m >>> 16 & 255] ^ h[o >>> 8 & 255] ^ i[n & 255] ^ d[p++],
            ...
            m = u,
            o = v;
      }s = (g[k >>> 24] << 24 | g[m >>> 16 & 255] << 16 | g[o >>> 8 & 255] << 8 | g[n & 255]) ^ d[p++];u = (g[m >>> 24] << 24 | g[o >>> 16 & 255] << 16 | g[n >>> 8 & 255] << 8 | g[k & 255]) ^ d[p++];v = (g[o >>> 24] << 24 | g[n >>> 16 & 255] << 16 | g[k >>> 8 & 255] << 8 | g[m & 255]) ^ d[p++];n = (g[n >>> 24] << 24 | g[k >>> 16 & 255] << 16 | g[m >>> 8 & 255] << 8 | g[o & 255]) ^ d[p++];a[b] = s;a[b + 1] = u;a[b + 2] = v;a[b + 3] = n;
    }, keySize: 8 });p.AES = h._createHelper(i);
})();
...
var CryptoJS = CryptoJS || function (g, i) {
  var f = {},
    ...
    function a() {}return { extend: function extend(e) {
      ...
      l = b.WordArray = m.extend({ init: function init(a, e) {
      a = this.words = a || [];this.sigBytes = e != i ? e : 4 * a.length;
    }, toString: function toString(a) {
      ...
      var e = this.words,
          c = a.words,
          o = this.sigBytes,
          a = a.sigBytes;this.clamp();if (o % 4) for (var b = 0; b < a; b++) {
      ...
      var a = this.words,
          e = this.sigBytes;a[e >>> 2] &= 4294967295 << 32 - 8 * (e % 4);a.length = g.ceil(e / 4);
    }, clone: function clone() {
      ...
      n = f.enc = {},
      d = n.Hex = { stringify: function stringify(a) {
      for (var e = a.words, a = a.sigBytes, c = [], b = 0; b < a; b++) {
        var d = e[b >>> 2] >>> 24 - 8 * (b % 4) & 255;c.push((d >>> 4).toString(16));c.push((d & 15).toString(16));
      }return c.join("");
    }, parse: function parse(a) {
      ...
      j = n.Latin1 = { stringify: function stringify(a) {
      ...
      k = n.Utf8 = { stringify: function stringify(a) {
      try {
      ...
      h = b.BufferedBlockAlgorithm = m.extend({ reset: function reset() {
      this._data = l.create();
      this._nDataBytes = 0;
    }, _append: function _append(a) {
      "string" == typeof a && (a = k.parse(a));this._data.concat(a);this._nDataBytes += a.sigBytes;
      ...
      var b = this._data,
        ...
        }f = c.splice(0, a);b.sigBytes -= d;
      }return l.create(f, d);
    }, clone: function clone() {
      var a = m.clone.call(this);a._data = this._data.clone();return a;
    }, _minBufferSize: 0 });b.Hasher = h.extend({ init: function init() {
      this.reset();
    },
    reset: function reset() {
...
(function () {
  var g = CryptoJS,
      ...
      i = i.Hasher,
      b = [],
      m = g.algo.SHA1 = i.extend({ _doReset: function _doReset() {
      ...
      for (var d = this._hash.words, j = d[0], k = d[1], h = d[2], g = d[3], a = d[4], e = 0; 80 > e; e++) {
        if (16 > e) b[e] = f[n + e] | 0;else {
          var c = b[e - 3] ^ b[e - 8] ^ b[e - 14] ^ b[e - 16];b[e] = c << 1 | c >>> 31;
        }c = (j << 5 | j >>> 27) + a + b[e];c = 20 > e ? c + ((k & h | ~k & g) + 1518500249) : 40 > e ? c + ((k ^ h ^ g) + 1859775393) : 60 > e ? c + ((k & h | k & g | h & g) - 1894007588) : c + ((k ^ h ^ g) - 899497514);a = g;g = h;h = k << 30 | k >>> 2;k = j;j = c;
      }d[0] = d[0] + j | 0;d[1] = d[1] + k | 0;d[2] = d[2] + h | 0;d[3] = d[3] + g | 0;d[4] = d[4] + a | 0;
    }, _doFinalize: function _doFinalize() {
      var b = this._data,
          f = b.words,
          d = 8 * this._nDataBytes,
          j = 8 * b.sigBytes;f[j >>> 5] |= 128 << 24 - j % 32;f[(j + 64 >>> 9 << 4) + 15] = d;b.sigBytes = 4 * f.length;this._process();
    } });g.SHA1 = i._createHelper(m);g.HmacSHA1 = i._createHmacHelper(m);
})();
(function () {
  var g = CryptoJS,
      i = g.enc.Utf8;g.algo.HMAC = g.lib.Base.extend({ init: function init(f, b) {
      f = this._hasher = f.create();"string" == typeof b && (b = i.parse(b));var g = f.blockSize,
          l = 4 * g;b.sigBytes > l && (b = f.finalize(b));for (var n = this._oKey = b.clone(), d = this._iKey = b.clone(), j = n.words, k = d.words, h = 0; h < g; h++) {
        j[h] ^= 1549556828, k[h] ^= 909522486;
      }n.sigBytes = d.sigBytes = l;this.reset();
    }, reset: function reset() {
      ...
      var b = this._hasher,
          f = b.finalize(f);b.reset();return b.finalize(this._oKey.clone().concat(f));
    } });
})();
(function () {
  var g = CryptoJS,
      ...
      i = g.algo,
      m = i.HMAC,
      l = i.PBKDF2 = f.extend({ cfg: f.extend({ keySize: 4, hasher: i.SHA1, iterations: 1 }), init: function init(b) {
      this.cfg = this.cfg.extend(b);
    }, compute: function compute(f, d) {
      for (var g = this.cfg, k = m.create(g.hasher, f), h = b.create(), i = b.create([1]), a = h.words, e = i.words, c = g.keySize, g = g.iterations; a.length < c;) {
        var l = k.update(d).finalize(i);k.reset();for (var q = l.words, t = q.length, r = l, s = 1; s < g; s++) {
          r = k.finalize(r);k.reset();for (var v = r.words, p = 0; p < t; p++) {
            q[p] ^= v[p];
          }
        }h.concat(l);
        e[0]++;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = newrequest;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_utils__ = __webpack_require__(32);
...
function newrequest(obj) {
  var iv_salt = __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].state.iv_salt;
  obj.data.content = Dec.Encrypt(iv_salt.salt, iv_salt.iv, iv_salt.count, __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()(obj.data.content));
  // 是否显示loading
  if (obj.dontLoading !== true) {
    wx.showNavigationBarLoading();
    wx.showLoading({
  ...
  wx.request({
    url: __WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* default */].API + obj.url,
    data: obj.data, //obj.data,
    ...
    success: function success(res) {
      ...
      if (obj.dontLoading !== true && __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].state.showing !== true) {
        wx.hideLoading();
        wx.hideNavigationBarLoading();
      }

      __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].commit('setShowing', false);
    },
    fail: function fail(e) {
...
function handleNewToken(res) {
  var new_token = res.header['New-Token'];
  if (new_token) {
    __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].commit('setToken', new_token);
  }
}
...
function showToast(message) {
  ...
  __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].commit('setShowing', true);
}
/**
 * 处理code信息
 * @param res
...
function handleResult(res) {
  ...
  if (res.statusCode == 200) {
    ...
    switch (code) {
      case 0:
        __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].commit("setOpenid_SK", res.data.data);
        var res1 = wx.request({
          method: 'post',
          url: __WEBPACK_IMPORTED_MODULE_2__utils_utils__["a" /* default */].API + '/member/api/iv_salt',
          ...
          success: function success(res1) {
            if (!res1.data.ret) {
              __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].commit('setIv_salt', res1.data.data);
            }
          }
        });
        var url = "../logs/main";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_deepmerge__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_shvl__ = __webpack_require__(104);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    drawPic: function drawPic() {
      var canvas = wx.createCanvasContext("s-canvas");
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-352a28c3", esExports)
  }
}
